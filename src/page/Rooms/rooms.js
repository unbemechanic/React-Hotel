...
import { Control, FacilityBackgrounds, FacilityD, FacilityP, FrameR, HomeBtn, HomeMainDiv, HomeP, HomeSecondP, Logo, LogoP, Main, OfferRoom, PlusIcon, PriceBtn, RoomCondition, RoomS, RoomsP } from '../../style'
...
const RoomsComponent = () => {
  ...
  <FacilityD>
      <FacilityP $title>ROOMS AND RATES</FacilityP>
      <FacilityP $paragraph>Each of our bright, light-flooded rooms come with everything you could possibly need for a comfortable stay. And yes, 
      comfort isn’t our only objective, we also value good design, sleek contemporary furnishing complemented 
      by the rich tones of nature’s palette as visible from our rooms’ sea-view windows and terraces.  </FacilityP>
      <FrameR>
        <RoomCondition>
           <OfferRoom $single>
        ...
        <Control>
          <RoomsP><PlusIcon>+</PlusIcon>VIEW ROOM DETAILS</RoomsP>
          <PriceBtn>$147 Avg/night</PriceBtn>
        </Control>
      </FrameR>
      <FrameR>
        <RoomCondition>
        ...
        <Control>
          <RoomsP><PlusIcon>+</PlusIcon>VIEW ROOM DETAILS</RoomsP>
          <PriceBtn>$155 Avg/night</PriceBtn>
        </Control>
      </FrameR>
      <FrameR>
        <RoomCondition>
           <OfferRoom $twin></OfferRoom>
           <p>TWIN ROOM</p>
        </RoomCondition>
        <Control>
          <RoomsP><PlusIcon>+</PlusIcon>VIEW ROOM DETAILS</RoomsP>
