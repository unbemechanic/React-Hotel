...
import { DesBtn, HomeBackgrounds, HomeBtn, HomeMainDiv, HomeP, HomeSecDes, HomeSecondP, Logo, LogoP, Main } from '../../style'
...
const HomeComponent = () => {
  return (
      ...
      <Main>
        ...
        <HomeBtn>
          <button><svg xmlns="http://www.w3.org/2000/svg" width="28" height="26" viewBox="0 0 28 26" fill="none">
            ...
            <div>
              <div style={{marginBottom:'20px'}}>Scroll</div>
    ...
    <Main $second>
        <HomeSecondP $title>All our room types are including complementary breakfast</HomeSecondP>
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr'}}>
          <div>
          <HomeSecDes>
            <HomeSecondP $redefined>Luxury redefined</HomeSecondP>
            <HomeSecondP>Our rooms are designed to transport 
            you into an environment made for leisure. 
            Take your mind off the day-to-day of home 
            life and find a private paradise for yourself.</HomeSecondP>
            <DesBtn>
              EXPLORE
            </DesBtn>
          </HomeSecDes>
          </div>
          <HomeBackgrounds $bed></HomeBackgrounds>
        </div>
      </Main>
      <Main $third>
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr'}}>
          <div >
          <HomeSecDes>
            <HomeSecondP $redefined>Leave your worries in the sand</HomeSecondP>
            <HomeSecondP>We love life at the beach. Being close
          ...
          <HomeBackgrounds $beach></HomeBackgrounds>
        </div>
      </Main>
      <Main $fourth>
        <div>
